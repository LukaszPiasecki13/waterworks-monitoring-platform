  ...
  return (
    <div>
      <div className="px-6 pt-6 pb-4 border-b border-neutral-200">
        <h2 className="text-lg font-semibold text-neutral-900">Moje konto</h2>
        <p className="text-sm text-neutral-600 mt-1">Zarządzaj danymi profilu i sprawdź swój dostęp</p>
      </div>
