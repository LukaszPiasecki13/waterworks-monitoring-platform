...
1. **Brak realnej zmiany** — delta stanu jest pusta, więc nie ma czego audytować (12 wystąpień, m.in. [`devices.py:159-161`](../../../backend/app/modules/core_data/services/devices.py#L159-L161), [`groups.py:203-205`](../../../backend/app/modules/security/services/groups.py#L203-L205)).
